...
<div class='panel panel-default grid'>
    <div class='panel-heading'>
        <i class='glyphicon glyphicon-th-list'></i> 凭证校区信息
        <div class='panel-tools'>

            <div class='btn-group'>
                <?php aci_ui_a($folder_name, 'school', 'add', '', ' class="btn  btn-sm "', '<span class="glyphicon glyphicon-plus"></span> 添加') ?>
            </div>
                ...
                <table class="table table-hover dataTable">
                    ...
                    <?php foreach ($data_list as $k => $v): ?>
                        <tr>
                            ...
                            <td><?php echo $v['编码'] ?></td>
                            <td><?php echo $v['800校区'] ?></td>
                            <td><?php echo $v['EAS成本中心'] ?></td>
                            <td><?php echo $v['公司'] ?></td>
                            <td>
                                <?php aci_ui_a($folder_name, 'school', 'edit', $v['id'], ' class="btn btn-default btn-xs"', '<span class="glyphicon glyphicon-edit"></span> 修改') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
