...
class MY_Controller extends CI_Controller
{
	...
	function _check_module()
	{
		...
		if($_aci_config==NULL)$this->showmessage($this->page_data['controller_name'].'模块:不能加载该Action',base_url($this->page_data['folder_name'].'/manage/index'),36000);
	...
	protected function showmessage($msg, $url_forward = '', $ms = 2000, $dialog = '', $returnjs = '') {
...
class Admin_Controller extends Member_Controller{
	...
	protected function showmessage($msg, $url_forward = '', $ms = 1000, $dialog = '', $returnjs = '') {
